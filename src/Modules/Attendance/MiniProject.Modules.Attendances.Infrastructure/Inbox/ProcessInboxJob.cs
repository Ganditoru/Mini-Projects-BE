...
using MiniProject.Modules.Attendances.Presentation;
using Dapper;

namespace MiniProject.Modules.Attendance.Infrastructure.Inbox;
    ...
    ILogger<ProcessInboxJob> logger) : IJob
{
        ...
        IDbTransaction transaction)
    {
        string sql =
            $"""
             ...
             FROM attendance2.inbox_messages
        ...
        Exception? exception)
    {
        const string sql =
            """
            UPDATE attendance2.inbox_messages
